# Lista de pendientes en React con TypeScript

[LISTA DE PENDIENTES CON REACT + TYPESCRIPT](https://lista-pendientes-react-js.netlify.app/)

Se crea una lista de tareas utilizando React con TypeScript. Se utilizan los componentes funcionales de React, el estado local y las propiedades tipadas. Al finalizar, dando como resultado una aplicación que te permitirá agregar y borrar tareas de una lista.
...
Agrega los estilos que se consideren adecuados.
